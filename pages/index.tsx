...
import { generateNewJson, graflinea, printCircleP, transitionCircle, text, findBigEstate, findBigEstateM, setText, findJson, printLine } from './components/Functions'
...
export default function Index() {
    ...
    function click() {
        d3.select("button")
            .on("click", () => {
                ...
                transitionCircle(newJson, fullyVaccinated)

                generateNewJson(newJson)
                transitionCircle(newJson, partiallyVaccinated)

                generateNewJson(newJson)
                transitionCircle(newJson, notVaccinated)
            });
    }
    ...
    return <>
        ...
        <div style={{ width: '17%', height: '150px', float: 'left', backgroundColor: '#E6E6FA' }}>
            <h4>Transition</h4>
            <button onClick={click}>transicionar</button>
            <h4>View data</h4>
